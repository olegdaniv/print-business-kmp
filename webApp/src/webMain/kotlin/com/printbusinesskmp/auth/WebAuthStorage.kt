...
internal expect fun sessionStorageGetItem(key: String): String?
internal expect fun sessionStorageSetItem(key: String, value: String)
internal expect fun sessionStorageRemoveItem(key: String)
